...
#ifndef soapIoSteerWSProxy_H
#define soapIoSteerWSProxy_H
#include "soapH.h"
class IoSteerWS
{   public:
	/// Runtime engine context allocated in constructor
	struct soap *soap;
	/// Endpoint URL of service 'IoSteerWS' (change as needed)
	const char *endpoint;
	...
	{ soap = soap_new(); endpoint = "http://mikeg.staff.shef.ac.uk/IOSteerWS.cgi"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual ~IoSteerWS() { if (soap) { soap_destroy(soap); soap_end(soap); soap_free(soap); } };
	/// Invoke 'add' of service 'IoSteerWS' and return error code (or SOAP_OK)
	virtual int ns__add(double a, double b, double *result) { return soap ? soap_call_ns__add(soap, endpoint, NULL, a, b, result) : SOAP_EOM; };
	/// Invoke 'getstep' of service 'IoSteerWS' and return error code (or SOAP_OK)
	virtual int ns__getstep(int id, int *step) { return soap ? soap_call_ns__getstep(soap, endpoint, NULL, id, step) : SOAP_EOM; };
	/// Invoke 'setstep' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getnsteps' of service 'IoSteerWS' and return error code (or SOAP_OK)
	virtual int ns__getnsteps(int id, int *nsstep) { return soap ? soap_call_ns__getnsteps(soap, endpoint, NULL, id, nsstep) : SOAP_EOM; };
	/// Invoke 'setnsteps' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'runsimulationstep' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'runsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'requestsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'runrequestedsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'submitsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'simulationstatus' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setsimulationstatus' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getsimulationresults' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'deletesimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'newsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'createsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'writelocalsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'readlocalsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'writesimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'readsimulation' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'exitiome' of service 'IoSteerWS' and return error code (or SOAP_OK)
	virtual int ns__exitiome(int id, int *status) { return soap ? soap_call_ns__exitiome(soap, endpoint, NULL, id, status) : SOAP_EOM; };
	/// Invoke 'addparamdouble' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'addparamint' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'addparamvec' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'addparammat' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'addparamstring' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'addparammmat3d' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'addmetadata' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getparamdouble' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getparamint' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getparamvec' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getparammat' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getparamstring' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getparammmat3d' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'getmetadata' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setparamdouble' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setparamint' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setparamvec' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setparammat' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setparamstring' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setparammmat3d' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setmetadata' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'listmetadata' of service 'IoSteerWS' and return error code (or SOAP_OK)
	virtual int ns__listmetadata(int id, char **list) { return soap ? soap_call_ns__listmetadata(soap, endpoint, NULL, id, list) : SOAP_EOM; };
	/// Invoke 'deletemetadata' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'deleteparam' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'listparam' of service 'IoSteerWS' and return error code (or SOAP_OK)
	...
	/// Invoke 'setgroupbarrier' of service 'IoSteerWS' and return error code (or SOAP_OK)
