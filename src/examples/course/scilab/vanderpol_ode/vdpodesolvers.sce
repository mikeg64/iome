...
function [xdot]=f3(t,v,ps,R,gam0,om)
  //f1=v*(R-ps^2)-ps;
  
  fqr=(ps/R);
  xdot= v*gam0*(1-(fqr*fqr))-om*om*ps;
...
for i=1:ntests
  ...
  sol=st(i,1);
  if sol == 0 then
        [ps,v,ta,time]=rk4(ps,v,ta,ha,R,gam0,om);
  elseif sol == 1 then 
        [ps,v,ta,time]=sciodes(ps,v,ta,ha,R,gam0,om);
  elseif sol == 2 then
        [ps,v,ta,time]=adams(ps,v,ta,ha,R,gam0,om);
  elseif sol == 3 then
        [ps,v,ta,time]=euler(ps,v,ta,ha,R,gam0,om);
  elseif sol == 4 then
        [ps,v,ta,time]=eulerpredictorcorrector(ps,v,ta,ha,R,gam0,om);        
  end,
