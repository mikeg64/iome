...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.9l 2010-04-07 08:46:52 GMT")
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setgroupbarrier), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setgroupbarrierResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "newstate", -1, &a->newstate, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__testgroupbarrier), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__testgroupbarrierResponse), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getobjnum), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getobjnumResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "objnum", -1, &a->objnum, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getnumobj), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getnumobjResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "numobj", -1, &a->numobj, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__listparam), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__listparamResponse), type))
		return soap->error;
	if (soap_out_PointerTostring(soap, "list", -1, &a->list, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__deleteparam), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__deleteparamResponse), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__deletemetadata), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__deletemetadataResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__listmetadata), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__listmetadataResponse), type))
		return soap->error;
	if (soap_out_PointerTostring(soap, "list", -1, &a->list, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setmetadata), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
		return soap->error;
	if (soap_out_string(soap, "property", -1, &a->property, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setmetadataResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparammmat3d), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
		return soap->error;
	if (soap_out_fdata(soap, "value", -1, &a->value, ""))
		return soap->error;
	if (soap_out_int(soap, "n", -1, &a->n, ""))
		return soap->error;
	if (soap_out_int(soap, "p", -1, &a->p, ""))
		return soap->error;
	if (soap_out_int(soap, "q", -1, &a->q, ""))
		return soap->error;
	if (soap_out_int(soap, "nr", -1, &a->nr, ""))
		return soap->error;
	if (soap_out_int(soap, "nc", -1, &a->nc, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparammmat3dResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamstring), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamstringResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparammat), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparammatResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamvec), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamvecResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamint), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
		return soap->error;
	if (soap_out_int(soap, "value", -1, &a->value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamintResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamdouble), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setparamdoubleResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__getmetadataResponse(struct soap *soap, const char *tag, int id, const struct ns__getmetadataResponse *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getmetadataResponse), type))
		return soap->error;
	if (soap_out_PointerTostring(soap, "property", -1, &a->property, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparammmat3d), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparammmat3dResponse), type))
		return soap->error;
	if (soap_out_PointerToPointerTofdata(soap, "mmat3d", -1, &a->mmat3d, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamstring), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamstringResponse), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparammat), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparammatResponse), type))
		return soap->error;
	if (soap_out_PointerToPointerTofdata(soap, "dval", -1, &a->dval, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamvec), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamvecResponse), type))
		return soap->error;
	if (soap_out_PointerToPointerTofdata(soap, "dval", -1, &a->dval, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamint), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamintResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "value", -1, &a->value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamdouble), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getparamdoubleResponse), type))
		return soap->error;
	if (soap_out_PointerTodouble(soap, "value", -1, &a->value, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addmetadata), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addmetadataResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparammmat3d), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
	...
	if (soap_out_int(soap, "nc", -1, &a->nc, ""))
		return soap->error;
	if (soap_out_int(soap, "iflag", -1, &a->iflag, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparammmat3dResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamstring), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamstringResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparammat), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparammatResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamvec), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamvecResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamint), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamintResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamdouble), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "name", -1, &a->name, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addparamdoubleResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__exitiome), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__exitiomeResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__readsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__readsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__writesimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "filename", -1, &a->filename, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__writesimulationResponse), type))
		return soap->error;
	if (soap_out_PointerTostring(soap, "filecontent", -1, &a->filecontent, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__readlocalsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "filename", -1, &a->filename, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__readlocalsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__writelocalsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "filename", -1, &a->filename, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__writelocalsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerTostring(soap, "filecontent", -1, &a->filecontent, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__createsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "filename", -1, &a->filename, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__createsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__newsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "simname", -1, &a->simname, ""))
		return soap->error;
	if (soap_out_string(soap, "xslname", -1, &a->xslname, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__newsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__deletesimulation), type))
		return soap->error;
	if (soap_out_int(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__deletesimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getsimulationresults), type))
		return soap->error;
	if (soap_out_int(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getsimulationresultsResponse), type))
		return soap->error;
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setsimulationstatus), type))
		return soap->error;
	if (soap_out_int(soap, "newstatus", -1, &a->newstatus, ""))
		return soap->error;
	if (soap_out_int(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setsimulationstatusResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__simulationstatus), type))
		return soap->error;
	if (soap_out_int(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__simulationstatusResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__submitsimulation), type))
		return soap->error;
	if (soap_out_string(soap, "simfilecontent", -1, &a->simfilecontent, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__submitsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__runrequestedsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__runrequestedsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "istatus", -1, &a->istatus, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__requestsimulation), type))
		return soap->error;
	if (soap_out_string(soap, "simfilecontent", -1, &a->simfilecontent, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__requestsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "isimid", -1, &a->isimid, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__runsimulation), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_string(soap, "simfilecontent", -1, &a->simfilecontent, ""))
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__runsimulationResponse), type))
		return soap->error;
	if (soap_out_PointerTostring(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__runsimulationstep), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_int(soap, "istepnum", -1, &a->istepnum, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__runsimulationstepResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "status", -1, &a->status, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setnsteps), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_int(soap, "newnsteps", -1, &a->newnsteps, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setnstepsResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "nsteps", -1, &a->nsteps, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getnsteps), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getnstepsResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "nsstep", -1, &a->nsstep, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setstep), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	if (soap_out_int(soap, "newstep", -1, &a->newstep, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__setstepResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "step", -1, &a->step, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getstep), type))
		return soap->error;
	if (soap_out_int(soap, "id", -1, &a->id, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__getstepResponse), type))
		return soap->error;
	if (soap_out_PointerToint(soap, "step", -1, &a->step, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
