...
#include <iome/utils/randomc.h>                   // define classes for random number generators
#include <iome/utils/userintf.cpp>                // define system specific user interface

// include code for one of the random number generators:
#include <iome/utils/mersenne.cpp>                // members of class TRandomMersenne
// or:
