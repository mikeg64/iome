#ifndef IO_AGENTXMLSIMULATION_AGENTXMLSIMULATION_H
#define IO_AGENTXMLSIMULATION_AGENTXMLSIMULATION_H
/*
IOME LICENSE
IOME Version 1.1.1
...
class CIoAgentXMLSimulation :
	public CIoWFSimulation
{
public:
	CIoAgentXMLSimulation(void);
	~CIoAgentXMLSimulation(void);
